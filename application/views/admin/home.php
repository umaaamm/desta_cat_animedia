      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
              ...
              <?php if (isset($_SESSION['level']) && $_SESSION['level'] == 'mahasiswa') { ?>
                <li><a href="<?php echo base_url()?>TestPeserta"><i class="fa fa-circle-o"></i> Test Peserta</a></li>
              <li><a href="<?php echo base_url()?>Soal/nilaiAll"><i class="fa fa-circle-o"></i> Semua Nilai</a></li>
              <li><a href="<?php echo base_url()?>ControllerLogin/logoutP"><i class="fa fa-circle-o"></i> Logout</a></li> 
         <?php  }elseif (isset($_SESSION['level']) && $_SESSION['level'] == 'Admin') { ?>
          <li><a href="<?php echo base_url()?>KelolaAdmin"><i class="fa fa-circle-o"></i> Kelola Data Admin</a></li>
              ...
              <li><a href="<?php echo base_url()?>KelolaPeserta"><i class="fa fa-circle-o"></i> Data Peserta</a></li>
...
<?php
// $sql   = "SELECT kode FROM npf WHERE tahun='2012' ";
// $query = mysqli_query( $koneksi, $sql )or die(mysqli_error());

$sql = $this->db->query("select * from ket_d")->result_array();
$sql1 = $this->db->query("select count(id_register) as total_peserta from tbl_peserta where status_peserta='1'")->result_array();
          ...
          chart1 = new Highcharts.Chart({
             ...
             yAxis: {
                ...
                [
                        ...
                        {
                          name: 'diterima',
                          data: [<?php echo $sql[0]['diterima'];?>]
                        },
                        {
                          name: 'Tidak diterima',
                          data: [<?php echo $sql[0]['tidak_diterima'];?>]
                        },
                        {
                          name: 'Pendaftar',
                          data: [<?php echo $sql1[0]['total_peserta'];?>]
                        },
                    ]
          });
       });  
